...
INSERT INTO "new_Pref" ("bio", "contentInterests", "faith", "filter", "id", "interests", "jobTitle", "scripturePref", "theme", "userId") SELECT "bio", "contentInterests", "faith", "filter", "id", "interests", "jobTitle", "scripturePref", "theme", "userId" FROM "Pref";
DROP TABLE "Pref";
